<template>
  <div class="upload-section">
    ...
    <p class="subtitle">See how your video will look in the YouTube feed before you publish</p>
    ...
    <div class="upload-form">
      ...
      <div class="form-group">
        ...
        <div class="character-count"><span>{{ titleCount }}</span>/100</div>
      </div>
...
export default {
  ...
  methods: {
    ...
    if (!this.videoTitle || !this.channelName || !this.thumbnailFile) {
      ...
      ${!this.thumbnailFile ? "✓ Thumbnail upload" : ""}`)
      return
    }
